...
public class NodeItemProvider 
	...
	protected void addPetrinetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Node_petrinet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Node_petrinet_feature", "_UI_Node_type"),
				 PetrinetPackage.Literals.NODE__PETRINET,
				 true,
				 false,
				 true,
				 null,
	...
	public ResourceLocator getResourceLocator() {
		return Petrinet2EditPlugin.INSTANCE;
	}
