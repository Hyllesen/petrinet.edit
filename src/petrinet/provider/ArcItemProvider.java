	...
	protected void addPetrinetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Arc_petrinet_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Arc_petrinet_feature", "_UI_Arc_type"),
				 PetrinetPackage.Literals.ARC__PETRINET,
				 true,
				 false,
				 true,
				 null,
